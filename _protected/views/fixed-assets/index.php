...
?>
<div class="fixed-assets-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Fixed Assets', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Person', 'id' => 'grid--person_id']
            ],
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Category', 'id' => 'grid--category_id']
            ],
        [
                'attribute' => 'room_id',
                'label' => 'Room',
                ...
                'filterInputOptions' => ['placeholder' => 'Room', 'id' => 'grid--room_id']
            ],
        [
